...
graph TD
    User((👨‍💻 End User))
    App[🖥️ Application Server (EC2)]
    
    subgraph "Amazon ElastiCache (Redis)"
        Primary[⚡ Primary Node <br/> 'Sub-millisecond RAM']
        Replica[⚡ Read Replica <br/> 'Multi-AZ Standby']
        
        Primary -. "Asynchronous Replication" .-> Replica
    end
    
    DB[(🗄️ Backend RDS Database)]
