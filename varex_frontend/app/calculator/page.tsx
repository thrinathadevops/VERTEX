...
const CALCULATORS: CalcConfig[] = [
  ...
  {
    key: "aws_rds", label: "AWS RDS Size Calculator",
    profiles: [{ key: "new", label: "New" }, { key: "existing", label: "Existing" }],
    fields: [...COMMON,
    { key: "engine", label: "Engine", type: "select", options: ["postgresql", "mysql", "mariadb", "oracle", "sqlserver", "aurora-postgresql", "aurora-mysql"] },
    { key: "deployment_model", label: "Deployment", type: "select", options: ["rds", "aurora"] },
    { key: "workload", label: "Workload", type: "select", options: ["oltp", "olap", "mixed", "reporting"] },
    { key: "storage_type", label: "Storage Type", type: "select", options: ["gp3", "io2", "standard"] },
    { key: "read_rps", label: "Read Ops / Sec", type: "number", min: 1, step: 1, placeholder: "5000" },
    { key: "write_rps", label: "Write Ops / Sec", type: "number", min: 1, step: 1, placeholder: "1000" },
    { key: "avg_query_kb", label: "Avg Query I/O (KB)", type: "number", min: 1, step: 1, placeholder: "8" },
    { key: "working_set_gb", label: "Working Set (GB)", type: "number", min: 1, step: 1, placeholder: "64" },
    { key: "data_size_gb", label: "Current Data Size (GB)", type: "number", min: 1, step: 1, placeholder: "500" },
    { key: "index_size_gb", label: "Index Size (GB)", type: "number", min: 0, step: 1, placeholder: "100" },
    { key: "temp_growth_gb", label: "Temp/Logs Growth (GB)", type: "number", min: 0, step: 1, placeholder: "50" },
    { key: "monthly_growth_gb", label: "Growth / Month (GB)", type: "number", min: 0, step: 1, placeholder: "20" },
    { key: "backup_retention_days", label: "Backup Retention (days)", type: "number", min: 1, max: 35, step: 1, placeholder: "7" },
    { key: "read_replicas", label: "Read Replicas", type: "number", min: 0, max: 15, step: 1, placeholder: "1" },
    { key: "multi_az", label: "Multi-AZ?", type: "boolean" },
    { key: "dev_test", label: "Dev/Test Cluster?", type: "boolean" },
    ],
  },
  {
    key: "documentdb", label: "Amazon DocumentDB",
    profiles: [{ key: "new", label: "New" }, { key: "existing", label: "Existing" }],
    fields: [...COMMON,
    { key: "read_rps", label: "Read Ops / Sec", type: "number", min: 1, step: 1, placeholder: "5000" },
    { key: "write_rps", label: "Write Ops / Sec", type: "number", min: 1, step: 1, placeholder: "1000" },
    { key: "avg_document_kb", label: "Avg Document Size (KB)", type: "number", min: 1, step: 1, placeholder: "10" },
    { key: "working_set_gb", label: "Working Set (GB)", type: "number", min: 1, step: 1, placeholder: "128" },
    { key: "data_size_gb", label: "Current Data Size (GB)", type: "number", min: 1, step: 1, placeholder: "500" },
    { key: "index_size_gb", label: "Index Size (GB)", type: "number", min: 0, step: 1, placeholder: "100" },
    { key: "monthly_growth_gb", label: "Growth / Month (GB)", type: "number", min: 0, step: 1, placeholder: "10" },
    { key: "backup_retention_days", label: "Backup Retention (days)", type: "number", min: 1, max: 35, step: 1, placeholder: "7" },
    { key: "secondary_regions", label: "Secondary Regions", type: "number", min: 0, max: 5, step: 1, placeholder: "0" },
    { key: "dev_test", label: "Dev/Test Cluster?", type: "boolean" },
    ],
  },
  {
